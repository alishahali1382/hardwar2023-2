...
public class GAs implements BranchPredictor {
    ...
    public BranchResult predict(BranchInstruction branchInstruction) {
        ...
        Bit [] a = getCacheEntry(CombinationalLogic.hash(branchInstruction.getInstructionAddress(), KSize, hashMode));
    ...
    public void update(BranchInstruction branchInstruction, BranchResult actual) {
        ...
        PSPHT.put(getCacheEntry(CombinationalLogic.hash(branchInstruction.getInstructionAddress(), KSize, hashMode)), newData);
